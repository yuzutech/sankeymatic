...
export const skmSettings = new Map([
  ['size_w', ['whole', 600, [40]]],
  ['size_h', ['whole', 600, [40]]],
...
export const settingsAppliedPrefix = '// \u2713 ' // u2713 = a little check mark

export const reNodeLine = /^:(.+) #([a-f0-9]{0,6})?(\.\d{1,4})?\s*(>>|<<)*\s*(>>|<<)*$/i
export const reFlowLine = /^(.+)\[([\d\s.+-]+)\](.+)$/
...
export const sampleDiagramRecipes = new Map([
